<?php namespace zgldh\Scaffold\Installer\Model\CommonFields;
 ...
 */
class DeletedAt extends FieldDefinition
{
    /**
     * 字段名 snake_case
     * @var string
     */
    private $name = 'deleted_at';
    /**
     * 数据库字段类型
     * @var string
     */
     ...
     * @param string $dbType
     */
    public function __construct($name = 'deleted_at', $dbType = 'timestamp')
    {
    ...
    {
        return 'scaffold::t.fields.deleted_at';
    }
}