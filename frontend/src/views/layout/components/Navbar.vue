<template>
  <el-menu class="navbar" mode="horizontal">
    ...
    <div class="right-menu">
      ...
      <notification-button class="right-menu-item"></notification-button>
      <el-dropdown class="avatar-container right-menu-item" trigger="hover">
        <div class="avatar-wrapper">
          <img v-if="avatar" class="user-avatar"
        ...
        <el-dropdown-menu class="user-dropdown" slot="dropdown">
          ...
          <el-dropdown-item divided>
            <span @click="logout" style="display:block;">{{$t('navbar.log_out')}}</span>
          </el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
    </div>
...
<script type="javascript">
  ...
  import NotificationButton from '@/components/NotificationWidget/Button'
